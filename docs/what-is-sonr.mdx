...
**Example:** Prad secures the prad.snr subdomain. If he wants to access Netflicks, a blockchain-based movie recommendation platform built on the Sonr blockchain, he can access his data at prad.snr/Netflicks and also grant other nodes access to his data.
