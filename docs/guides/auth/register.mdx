...
The createAccount method returns a `Future` that resolves to a [`Whois`](/protodocs/registry/who_is.proto#whois) object.
...
void createAccount() async {
    ...
    WhoIs? res = await motor.createAccount(
      "A-Really_Strong_Password-123456",
    ...
    if (res != null) {
      print("WhoIs: $res");
      // This doesn't automatically login the user, you need to call `login` to do that
