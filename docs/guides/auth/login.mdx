...
:::note
When performing a `Login` operation, an optional password. password can be provided but is not required.
If a password is not provided, the operating system keychain will be provided.
:::
