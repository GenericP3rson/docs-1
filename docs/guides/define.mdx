...
Consider the questions below in defining your problem and user scenario. While user need is typically highest priority, different contexts may warrant new 
prioritizations. 
...
3. **Objects (SchemaDocuments)** - When and how will instances of my defined schema get created? 
4. **Buckets** - How will I group and store my objects? 
