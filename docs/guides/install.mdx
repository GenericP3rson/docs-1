...
<APIButton href="/docs/reference/speedway/cli.mdx" label="CLI Reference" />
...
Begin using Speedway by cloning the repository

```bash
git clone git@github.com:sonr-io/speedway.git
```

### 2. Build the Speedway CLI
...
<img src="/assets/new-project.png" width="100%" />
...
<img src="/assets/build-gradle.png" width="100%" />

...and your `:app` level `build.gradle` should look like this.

<img src="/assets/build-gradle-app.png" width="100%" />
...
- [Authentication](/docs/guides/auth/register.mdx)
- [Documents](/docs/guides/data/documents.mdx)
- [Buckets](/docs/guides/storage/buckets.mdx)
- [Reference](/docs/reference/motor/go.md)
