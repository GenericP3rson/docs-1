...
const sidebars = {
  ...
  speedwaySidebar: [
    'speedway/intro/overview', 'speedway/intro/installation',
    {
      type: 'category',
      label: 'Guides',
      collapsed: true,
      items: ['speedway/guides/cli-example', 'speedway/guides/flutter-example'],
    },
    {
      type: 'category',
      label: 'API',
      collapsed: false,
      collapsible: false,
      items: ['speedway/api/cli-cmds', 'speedway/api/routes'],
    },
  ],
};
