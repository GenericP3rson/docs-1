...
![Create Object GIF](https://github.com/sonr-io/docs/blob/main/assets/build-object-cli.gif)
...
![Create Bucket GIF](https://github.com/sonr-io/docs/blob/main/assets/create-bucket-cli.gif)
