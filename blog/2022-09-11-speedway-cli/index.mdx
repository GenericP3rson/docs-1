...
---
## Introduction
In this dissertation, we will be going over Speedway Command-Line Interface (CLI). Speedway is a developer tool used to create applications on the Sonr Network. First, we'll dive into the installation of Speedway binary and how to create an account on the Sonr network using Speedway CLI. Then we will go over the modules of Sonr ([Registry](https://www.sonr.dev/docs/reference/modules/registry), [Schemas](https://www.sonr.dev/docs/reference/modules/schemas), [Objects](https://www.sonr.dev/docs/reference/modules/objects) & [Buckets](https://www.sonr.dev/docs/reference/modules/buckets)) and how to build applications with them. We will also be building the initial components of a simple application using Speedway CLI.
